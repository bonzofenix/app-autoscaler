...
metricsforwarder_health_password: autoscaler_metricsforwarder_health_password
operator_health_password: autoscaler_operator_health_password
eventgenerator_health_password: autoscaler_eventgenerator_health_password
scalingengine_health_password: autoscaler_scalingengine_health_password
service_broker_password_blue: service_broker_password_blue
service_broker_password: service_broker_password
