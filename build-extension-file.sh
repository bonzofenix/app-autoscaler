...
credhub generate -n "/bosh-autoscaler/${DEPLOYMENT_NAME}/autoscaler_metricsforwarder_health_password" --length 16 -t password
credhub generate -n "/bosh-autoscaler/${DEPLOYMENT_NAME}/autoscaler_operator_health_password" --length 16 -t password
credhub generate -n "/bosh-autoscaler/${DEPLOYMENT_NAME}/autoscaler_eventgenerator_health_password" --length 16 -t password
credhub generate -n "/bosh-autoscaler/${DEPLOYMENT_NAME}/autoscaler_scalingengine_health_password" --length 16 -t password
credhub generate -n "/bosh-autoscaler/${DEPLOYMENT_NAME}/service_broker_password_blue" --length 16 -t password
credhub generate -n "/bosh-autoscaler/${DEPLOYMENT_NAME}/service_broker_password" --length 16 -t password
